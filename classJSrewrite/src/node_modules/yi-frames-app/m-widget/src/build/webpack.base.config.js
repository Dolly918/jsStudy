...
module.exports={
	...
	resolve: {
        ...
        alias: {
		    yiframes:path.resolve(__dirname,'../node_modules/yi-frames-js/src/js/conf/yiframes'),
		    uijs:path.resolve(__dirname,'../node_modules/yi-frames-js/src/js/conf/yiframes.ui'),
		    utils:path.resolve(__dirname,'../node_modules/yi-frames-js/src/js/conf/yiframes.utils'),
		    uiPath:path.resolve(__dirname,'../node_modules/yi-frames-js/src/js/common/ui'),
        	utilsPath:path.resolve(__dirname,'../node_modules/yi-frames-js/src/js/common/utils'),
		}
    },
    module:{
    	rules:[
