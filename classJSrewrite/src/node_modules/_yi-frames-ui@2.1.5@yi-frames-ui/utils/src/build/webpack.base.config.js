...
module.exports={
	...
	resolve: {
        ...
        alias: {
			...
			'@wxUtilsPath':path.resolve(__dirname,'../node_modules/yi-frames-wx/utils/src/js/common'),

			'@utilsV2': path.resolve(__dirname, '../node_modules/yi-frames-wx/utils/src/js/common'),
		}
    },
    module:{
    	rules:[
